...
import checkers.controller.controllerComponent.GameState._
...
import checkers.model.gameBoardComponent.gameBoardBaseImpl.{Field, GameBoard, GameBoardCreator, Piece}
import play.api.libs.json.JsValue
import checkers.util.{Mover, UndoManager}
import checkers.Checkers.{controller, gui}
import checkers.CheckersModule
import checkers.controller.controllerComponent.{ControllerInterface, FieldChanged, GBSizeChanged, GameState}
...
class Controller @Inject() (var gameBoard: GameBoardInterface) extends ControllerInterface with Publisher {
  ...
  def toJson: JsValue = gameBoard.toJson
}